...
// * CompanyWebDashboard
//=========================================================================
// - The web app dashboard for a compoany for bulk managing jobs
//_________________________________________________________________________
@Component({
  selector: 'page-company-web-dashboard',
  templateUrl: 'company-web-dashboard.html'
})
export class CompanyWebDashboard {
